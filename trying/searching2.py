...
def exact_search(neighborhoods, search_name):
    ...
    for record in neighborhoods:
       ...
       # print(f"Aranan: {search_name}, Bulunan: {neighborhood_name}")
        print(f"Aranan: {search_name.upper()}, Bulunan: {neighborhood_name.upper()}")
...
def partial_search(neighborhoods, search_term):
    ...
    for record in neighborhoods:
        ...
        if search_term.upper() in neighborhood_name.upper(): #içerme(in)
            matches.append(record)
    return matches
